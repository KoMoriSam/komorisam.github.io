<template>
  <section v-if="serverInfo" class="prose prose-sm">
    <div
      class="stats stats-vertical lg:stats-horizontal bg-info-content text-info shadow"
    >
      <div class="stat">
        <div class="stat-title text-info/75">
        ...
        <div class="stat-desc text-info/75">{{ serverInfo.city }}</div>
      </div>
      <div class="stat">
        <div class="stat-title text-info/75">
          <div
        ...
        <div class="stat-desc text-info/75">{{ serverInfo.motd }}</div>
      </div>
      ...
      <div class="stat" v-if="serverInfo.ping !== null">
        ...
        <div class="stat-desc text-info/75">
          <span
